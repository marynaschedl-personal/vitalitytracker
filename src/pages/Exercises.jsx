    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <DashboardCard>
          ...
          <p className="text-xs text-muted-foreground">of {exerciseGoal} daily</p>
        </DashboardCard>
        ...
        <DashboardCard>
          ...
          <p className="text-xs text-muted-foreground">{totalCalories} calories</p>
        </DashboardCard>
      </div>
      ...
      <DashboardCard>
        <div className="flex justify-between items-center mb-4">
          <h2 className="font-semibold text-foreground">Today's Workouts</h2>
